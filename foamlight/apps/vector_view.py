...
from foamgraph import FoamColor, PlotWidgetF, TimedPlotWidgetF
...
class VectorPlot(PlotWidgetF):
    ...
    def __init__(self, *, parent=None):
        ...
        self._plot1 = self.plotCurve(name="Vector1", pen=FoamColor.mkPen('b'))
        self._plot2 = self.plotCurve(
            name="Vector2", pen=FoamColor.mkPen('r'), y2=True)
...
class VectorCorrelationPlot(TimedPlotWidgetF):
    ...
    def __init__(self, *, parent=None):
        ...
        self._plot = self.plotScatter(brush=FoamColor.mkBrush('g', alpha=120))
