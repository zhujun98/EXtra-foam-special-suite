...
from foamlight.apps.tr_xas import (
    TrXas, TrXasProcessor, TrXasSpectraPlot, TrXasRoiImageView, TrXasHeatmap,
...
class TestTrXasWidget(_AppTestBase):
    @classmethod
    def setUpClass(cls):
        cls._app = TrXas('SCS')
    ...
    def testWidgets(self):
        self.assertEqual(6, len(self._app._plot_widgets_st))
        counter = Counter()
    ...
    def testCtrl(self):
        ...
        self.assertTrue(self._app._a21._plot_area.getAxis("bottom").label.toPlainText())
        self.assertTrue(self._app._a13_a23._plot_area.getAxis("bottom").label.toPlainText())
        self.assertTrue(self._app._a21_heatmap._plot_widget._plot_area.getAxis("left").label.toPlainText())
        self.assertTrue(self._app._a21_heatmap._plot_widget._plot_area.getAxis("bottom").label.toPlainText())
        ...
        with patch.object(self._app._a21, "setLabel") as mocked_setLabel1:
            with patch.object(self._app._a13_a23, "setLabel") as mocked_setLabel2:
                with patch.object(self._app._a21_heatmap, "setLabel") as mocked_setLabel3:
...
# class TestTrXasProcessor(_TestDataMixin, _ProcessorTestBase):
